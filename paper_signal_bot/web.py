            ...
            self.send_json(
                {
                    ...
                    "macro_event_watch": {
                        ...
                        "sources": [
                            ...
                            "Atlanta Fed GDPNow",
                            "BLS Public Data API for official CPI/PPI/jobs actuals",
                            "Federal Reserve target-rate table for official FOMC actuals",
                            "Census Econ Indicators for official retail/housing actuals",
                            "BEA current releases for official GDP/PCE actuals",
                            "Trading Economics consensus/actual when configured (optional)",
                        ...
                        "post_event_updates": ["OFFICIAL_RESULT", "CRYPTO_REACTION_1H"],
